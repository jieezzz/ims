...
<li><a href="itemsinuseUpdated.php">ITEMS IN USE / </a></li>		
		  <li class="active">AVAIL ITEMS</li>
		</ol>
<br>
...
<div class="controler">
    ...
    <div class="panel-heading"  style="background-color:#c6d3eb;"> AVAILABLE ITEMS LIST</div>
            ...
            <tbody>
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <a class='btn btn-danger btn-sm' href='useitemUpdate.php?id=$row[id]'> USE ITEM</a>
                        </td>";
                        echo "</tr>";
                    }
